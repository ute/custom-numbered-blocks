...
Two new ways a custom block can be rendered are available now:
 ...
 - **simpletextbox** is a simple example for a definition that uses color
...
If you include files inside a custom numbered block, it may break the div structure. To avoid this, enclose it in another div
