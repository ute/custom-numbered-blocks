...
With the new version, nested blocks are numbered within the enclosing parent block, if the parent block is also numbered. To suppress numbers,  specify class `.unnumbered` as usual.
:::
